...
export default function BreastCancerDetection({ logoutFunction }) {
  ...
  const HEALTH_BG = "https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=1920&q=90";
        ...
        <div className="w-full">
          <div className="w-full">
            ...
            <div className="flex flex-wrap items-center bg-slate-800 rounded-md shadow-md">
              <label
                htmlFor="file-upload"
                className="cursor-pointer bg-slate-700 hover:bg-slate-600 px-4 py-2 rounded-l-md text-xs sm:text-sm font-medium flex-shrink-0 flex items-center space-x-2"
              >
